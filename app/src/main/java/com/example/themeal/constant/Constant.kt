...
object Constant {
    ...
    const val RECENT_LIST = "Recent"
    const val NEW_LIST = "New"
    const val ALL_LIST = "All"
    const val TITLE_TOOL_BAR = "titleToolBar"
    const val KEY_LIST_DATA = "list"
    const val KEY_DATA = "data"
    const val KEY_INGREDIENT = "ingredientDetail"
    const val KEY_MEAL = "mealDetail"
